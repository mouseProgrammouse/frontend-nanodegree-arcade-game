...
var Engine = (function(global) {
  ...
  //render popup with scores
  function renderPopup(scores) {
    ctx.fillStyle = '#dfd9c8';
    ctx.fillRect(100, 195, 305, 200);
    ctx.fillStyle = '#e9e9e0';
    ctx.fillRect(110, 205, 285, 180);
    ctx.strokeRect(100, 195, 305, 200);
    //show message
    //fillText(text, x, y [, maxWidth])
    ctx.fillStyle = '#000000';
    ctx.font = '32px serif';
    ctx.fillText('Game over', 185, 240);
    ctx.font = '18px serif';
    ctx.fillText('Press enter to continue.', 170, 270);
    ctx.fillText('Your final score is', 190, 290);
    //score
    ctx.fillStyle = '#5169d4';
    ctx.font = '32px serif';
    ctx.fillText(scores, 238, 330);
  }
   ...
   * if user press enter - restart the game
   */
